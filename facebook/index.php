...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right">
            ...
            <div class="form-group">
              <input type="password" id='txt-contra' placeholder="Password" class="form-control">
            </div>
            <button type="button" id='btn-iniciar' class="btn btn-primary">Iniciar sesión</button>
     ...
     <div class="alert alert-success" id="div-verde"><img id="imagen" src="img/loading.gif" style="display: none;"></div>
    ...
    <div class="container">
      ...
      <div class="row ">
        <div class="col-md-6">
          ...
          <p>ID: <input type="text" id="txt-id-usuario" class="form-control" disabled="disabled" value="1"><br>
          Perfil actual: <input type="text" id="txt-nombre"  class="form-control" disabled="disabled" value="Patricio"></p>
          <p>Elija el perfil que representa actualmente. </p>
          <div class="rowglyphicon-thumbs-up" id="div-quiensoy">
           <?php ?>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <div class="rowglyphicon-thumbs-up" id="div-aleros"> 
          </div>
        </div>         
       </div>
       <div class="col-md-6 ">
          ...
          <div class="rowglyphicon-thumbs-up" id="div-nocompis">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btn-registro-usuario" class="btn btn-primary">Guardar</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-4 col-sm-2 col-md-2 col-lg-2 ">
            <div class="well">
              Utilizar la imagen loading.gif para simular la carga, ejemplo: 
            </div>
          </div>
        </div>
      </div>
