...
<body>
	...
	function hola(){
		var cont=0;
		for (var x+0; x<checkboxes.lenght; x++){
		...
		document.writeln(cont);
					...
					<?php
						for($i=0;$i<count($repuestos);$i++){
							...
							if (isset($_GET["repuestos[]"])) 
								if (in_array($repuestos[$i]->getCodigoRepuesto(),$repuestos,true))
						...
						/*function hola(){
							...
							echo "I'm really blessing, 'cause I've the best boyfriend in the whole world";
						}*/
					?>
				</td>
			</tr>
